...
//  Higher SPI1 clock only results in faster transfer to hosts on a LAN
...
// Require Ethernet_spi1.h, because we need MAX_SOCK_NUM
#ifndef ethernet_h_
#error "Ethernet_spi1.h must be included before w5100.h"
#endif


// Arduino 101's SPI1 can not run faster than 8 MHz.
